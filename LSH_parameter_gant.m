...
%     train_path_t = 'Data\result\20190426\LSH_Cluster';
    train_path_t = 'Data\result\20190427\LSH_Cluster_gant';
    base_name = sprintf('%s%.1f.mat',train_path_t,splitNumber);
%     base_name = 'Data\result\20190422\LSH_Cluster.mat';
    save(base_name,'Compactness_kmeans_plus_table','Separation_kmeans_plus_table','t_kmeans_plus_table','Compactness_mod_lsh_table','Separation_mod_lsh_table','time_mod_table','Compactness_kmeans','Separation_kmeans','t_kmeans_table');
end
